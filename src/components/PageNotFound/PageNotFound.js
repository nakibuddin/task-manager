...
const PageNotFound = () => {
    return (
        <section className="flex items-center h-full sm:p-16  bg-gray-900  text-gray-100 md:mx-16 rounded-md">
            <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-lg">
                ...
                <Link to='/add-task' className="px-8 py-3 font-semibold rounded  bg-violet-400  text-gray-900">Back to homepage</Link>
            </div>
        </section>
    );
};
